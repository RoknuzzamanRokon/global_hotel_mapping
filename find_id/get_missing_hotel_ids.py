'''
    Description : This script is used to find the missing hotel ids from the global_hotel_mapping table and vervotech_mapping table.
        It will save the missing hotel ids to a file named All_get_data_for_new_and_missing_file.txt.
        The file will be saved in the directory specified in the .env file.
